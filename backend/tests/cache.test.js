...
const redis_1 = require('../src/loaders/redis');
...
describe('Redis Caching', () => {
  ...
  beforeEach(() => {
    ...
    redis_1.getRedisClient.mockReturnValue(mockRedis);
  });
  afterEach(() => {
    jest.clearAllMocks();
  });
  describe('withCache', () => {
    it('should return cached data on cache hit', async () => {
      ...
      const result = await (0, cache_1.withCache)(
  ...
  describe('deleteCache', () => {
    it('should delete cache entry for given prefix and params', async () => {
      ...
      await (0, cache_1.deleteCache)('search', { query: 'test', page: 1 });
    ...
    it('should handle deletion errors gracefully', async () => {
      ...
      await expect(
        (0, cache_1.deleteCache)('search', { query: 'test' })
  ...
  describe('invalidateCacheByPrefix', () => {
    it('should delete all keys matching prefix', async () => {
      ...
      await (0, cache_1.invalidateCacheByPrefix)('search');
  ...
  describe('Cache Key Generation', () => {
    it('should generate cache keys with prefix', async () => {
      ...
      await (0, cache_1.withCache)(
        { prefix: 'myprefix', ttl: 300, params: {} },
        fetchFn
      );
